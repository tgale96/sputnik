...
struct BdsdKernel_b32_m32n64k32_half8_half8 {
...
__global__ void __launch_bounds__(32) LaunchBdsd_b32_m32n64k32_half8_half8(
    int m, int k, int n,
    const half2* __restrict__ values,
    const int* __restrict__ offsets,
    const short2* __restrict__ indices,
  ...
  BdsdKernel_b32_m32n64k32_half8_half8::KernelFn(
...
cudaError_t CudaBdsd(int m, int k, int n,
  ...
  LaunchBdsd_b32_m32n64k32_half8_half8<<<grid_dim, block_dim, 0, stream>>>(
