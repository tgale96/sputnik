...
using dds_mixed_b128_256x128x32x3_nt_align8_base =
...
// Define named type
struct dds_mixed_b128_256x128x32x3_nt_align8 :
  public dds_mixed_b128_256x128x32x3_nt_align8_base { };
...
bool can_launch_dds_mixed_b128_256x128x32x3_nt_align8(
  ...
  using Dds = Kernel<dds_mixed_b128_256x128x32x3_nt_align8>;
