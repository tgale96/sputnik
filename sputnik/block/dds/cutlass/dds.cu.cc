...
static const bool k1 = RegisterKernel(can_launch_dds_mixed_b128_256x128x32x3_nt_align8,
                                      launch_dds_mixed_b128_256x128x32x3_nt_align8);
static const bool k2 = RegisterKernel(can_launch_dds_mixed_b128_256x128x32x3_nn_align8,
                                      launch_dds_mixed_b128_256x128x32x3_nn_align8);
static const bool k3 = RegisterKernel(can_launch_dds_mixed_b128_256x128x32x3_tn_align8,
                                      launch_dds_mixed_b128_256x128x32x3_tn_align8);
static const bool k4 = RegisterKernel(can_launch_dds_mixed_b128_256x128x32x3_tt_align8,
                                      launch_dds_mixed_b128_256x128x32x3_tt_align8);
