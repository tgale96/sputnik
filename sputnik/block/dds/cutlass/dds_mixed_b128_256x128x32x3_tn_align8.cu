...
using dds_mixed_b128_128x128x32x5_tn_align8_base =
...
// Define named type
struct dds_mixed_b128_128x128x32x5_tn_align8 :
  public dds_mixed_b128_128x128x32x5_tn_align8_base { };
...
bool can_launch_dds_mixed_b128_128x128x32x5_tn_align8(
  ...
  using Dds = Kernel<dds_mixed_b128_128x128x32x5_tn_align8>;
