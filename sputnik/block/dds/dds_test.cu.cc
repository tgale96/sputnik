...
struct Problem {
  static_assert(kNonZeros_ <= kDimK_ * kDimN_,
...
typedef ::testing::Types<
    ...
    Problem<8, 128, 128, 128*128, 128>,
    Problem<8, 256, 128, 256*128, 128>,
    Problem<8, 128, 256, 256*128, 128>,
    Problem<512, 128, 128, 128*128, 128>,
    Problem<8, 256, 128, 128*128, 128>,
    Problem<8, 256, 256, 256*128, 128>,
    // Block 128 problems TN.
    Problem<8, 128, 128, 128*128, 128, true>,
    Problem<8, 256, 128, 256*128, 128, true>,
    Problem<8, 128, 256, 256*128, 128, true>,
    Problem<512, 128, 128, 128*128, 128, true>,
    Problem<8, 256, 128, 128*128, 128, true>,
    Problem<8, 256, 256, 256*128, 128, true>,
    // Block 128 problems NT.
    Problem<8, 128, 128, 128*128, 128, false, true>,
    Problem<8, 256, 128, 256*128, 128, false, true>,
    Problem<8, 128, 256, 256*128, 128, false, true>,
    Problem<512, 128, 128, 128*128, 128, false, true>,
    Problem<8, 256, 128, 128*128, 128, false, true>,
    Problem<8, 256, 256, 256*128, 128, false, true>,
    // Block 128 problems TT.
    Problem<8, 128, 128, 128*128, 128, true, true>,
    Problem<8, 256, 128, 256*128, 128, true, true>,
    Problem<8, 128, 256, 256*128, 128, true, true>,
    Problem<512, 128, 128, 128*128, 128, true, true>,
    Problem<8, 256, 128, 128*128, 128, true, true>,
    Problem<8, 256, 256, 256*128, 128, true, true>,
    // Larger problems NN.
    Problem<1024, 512, 512, 512*512, 128>,
    Problem<1024, 512, 512, 256*512, 128>,
    Problem<1024, 512, 512, 128*512, 128>,
    Problem<1024, 1024, 1024, 1024*1024, 128>,
    Problem<1024, 1024, 1024, 512*1024, 128>,
    Problem<1024, 1024, 1024, 256*1024, 128>,
    // Larger problems TN.
    Problem<1024, 512, 512, 512*512, 128, true>,
    Problem<1024, 512, 512, 256*512, 128, true>,
    Problem<1024, 512, 512, 128*512, 128, true>,
    ...
    // Larger problems NT.
    Problem<1024, 512, 512, 512*512, 128, false, true>,
    Problem<1024, 512, 512, 256*512, 128, false, true>,
    Problem<1024, 512, 512, 128*512, 128, false, true>,
    ...
    // Larger problems TT.
    Problem<1024, 512, 512, 512*512, 128, true, true>,
    Problem<1024, 512, 512, 256*512, 128, true, true>,
    Problem<1024, 512, 512, 128*512, 128, true, true>,
    ...
    Problem<1024, 512, 512, 512*512, 128, false, false, true>,
    Problem<1024, 512, 512, 256*512, 128, false, false, true>,
    Problem<1024, 512, 512, 128*512, 128, false, false, true>,
    ...
    Problem<1024, 512, 512, 512*512, 128, true, false, true>,
    Problem<1024, 512, 512, 256*512, 128, true, false, true>,
    Problem<1024, 512, 512, 128*512, 128, true, false, true>,
    ...
    Problem<1024, 512, 512, 512*512, 128, false, true, true>,
    Problem<1024, 512, 512, 256*512, 128, false, true, true>,
    Problem<1024, 512, 512, 128*512, 128, false, true, true>,
    ...
    Problem<1024, 512, 512, 512*512, 128, true, true, true>,
    Problem<1024, 512, 512, 256*512, 128, true, true, true>,
    Problem<1024, 512, 512, 128*512, 128, true, true, true>,
...
TYPED_TEST_SUITE(DdsTest, TestProblems);

TYPED_TEST(DdsTest, Dds) {
  ...
  BlockSparseMatrix rhs_(
      odb, ldb, this->kNonZeros, this->kBlockDim,
