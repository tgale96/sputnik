...
using ssd_mixed_b128_128x128x32x5_tt_align8_base =
...
// Define named type
struct ssd_mixed_b128_128x128x32x5_tt_align8 :
  public ssd_mixed_b128_128x128x32x5_tt_align8_base { };
...
bool can_launch_ssd_mixed_b128_128x128x32x5_tt_align8(
  ...
  using Ssd = Kernel<ssd_mixed_b128_128x128x32x5_tt_align8>;
...
cudaError_t launch_ssd_mixed_b128_128x128x32x5_tt_align8(
  ...
  using Ssd = SparseOutputKernel<ssd_mixed_b128_128x128x32x5_tt_align8>;
