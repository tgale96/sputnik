...
using dss_mixed_b128_128x128x32x5_nt_align8_base =
...
// Define named type
struct dss_mixed_b128_128x128x32x5_nt_align8 :
  public dss_mixed_b128_128x128x32x5_nt_align8_base { };
...
bool can_launch_dss_mixed_b128_128x128x32x5_nt_align8(
  ...
  using Dss = Kernel<dss_mixed_b128_128x128x32x5_nt_align8>;
...
cudaError_t launch_dss_mixed_b128_128x128x32x5_nt_align8(
  ...
  Dss::Arguments args({shape.m, shape.n, shape.k},
                      ...
                      {b.data, b.offsets, b.indices, nullptr, b.bitmask, shape.ldb},
                      {c.data, shape.ldc},
                      {c.data, shape.ldc});
