...
// using dsd_mixed_b128_128x256x32x3_tn_align8_base =
...
// // Define named type
// struct dsd_mixed_b128_128x256x32x3_tn_align8 :
//   public dsd_mixed_b128_128x256x32x3_tn_align8_base { };
...
// // TODO(tgale): We can update this API to take simple structs
// // that carry the pointers and meta-data so that we don't
// // have to have additional arguments for the transposed
// // sparse matrix.
...
//   // DEBUG: Setup to work for single block row case.
//   Dsd::Arguments args({m, n, k},
//                       {1.0f, 0.0f},
//                       {a, offsets_a, indices_a, indices_a, /*lda=*/k},
//                       {b, /*ldb=*/n},
//                       {c, /*ldc=*/n},
//                       {c, /*ldc=*/n});
