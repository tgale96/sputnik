...
using dsd_mixed_b128_128x128x32x5_tn_align8_base =
...
// Define named type
struct dsd_mixed_b128_128x128x32x5_tn_align8 :
  public dsd_mixed_b128_128x128x32x5_tn_align8_base { };
...
bool can_launch_dsd_mixed_b128_128x128x32x5_tn_align8(
  ...
  using Dsd = Kernel<dsd_mixed_b128_128x128x32x5_tn_align8>;
