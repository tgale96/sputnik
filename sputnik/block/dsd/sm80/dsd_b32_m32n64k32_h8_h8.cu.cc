...
struct dsd_b32_m32n64k32_h8_h8 {
...
__global__ void __launch_bounds__(32) dsd_b32_m32n64k32_h8_h8_kernel(
    int m, int k, int n,
    const half2* __restrict__ values,
    const int* __restrict__ offsets,
    const short2* __restrict__ indices,
  ...
  dsd_b32_m32n64k32_h8_h8::KernelFn(
...
cudaError_t launch_dsd_b32_m32n64k32_h8_h8(
  ...
  dsd_b32_m32n64k32_h8_h8_kernel<<<grid_dim, block_dim, 0, stream>>>(
