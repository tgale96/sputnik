...
using sds_mixed_b128_128x128x32x5_nt_align8_base =
...
// Define named type
struct sds_mixed_b128_128x128x32x5_nt_align8 :
  public sds_mixed_b128_128x128x32x5_nt_align8_base { };
...
bool can_launch_sds_mixed_b128_128x128x32x5_nt_align8(
  ...
  using Sds = Kernel<sds_mixed_b128_128x128x32x5_nt_align8>;
...
cudaError_t launch_sds_mixed_b128_128x128x32x5_nt_align8(
  ...
  using Sds = SparseOutputKernel<sds_mixed_b128_128x128x32x5_nt_align8>;
