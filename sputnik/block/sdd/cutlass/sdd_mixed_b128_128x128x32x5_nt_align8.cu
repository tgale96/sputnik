...
using sdd_mixed_b128_128x128x32x5_nt_align8_base =
...
// Define named type
struct sdd_mixed_b128_128x128x32x5_nt_align8 :
  public sdd_mixed_b128_128x128x32x5_nt_align8_base { };

}  // namespace


bool can_launch_sdd_mixed_b128_128x128x32x5_nt_align8(
    const Matrix a, bool transpose_a,
    const Matrix b, bool transpose_b, BlockMatrix c) {
  using Sdd = Kernel<sdd_mixed_b128_128x128x32x5_nt_align8>;
...
cudaError_t launch_sdd_mixed_b128_128x128x32x5_nt_align8(
    const Matrix a, bool transpose_a,
    const Matrix b, bool transpose_b,
    BlockMatrix c, cudaStream_t stream) {
  using Sdd = SparseOutputKernel<sdd_mixed_b128_128x128x32x5_nt_align8>;
